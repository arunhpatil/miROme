...
out.write("#SBATCH --partition=preempt --time=2-00:00:00 --output=h_rundata2.log -c 40 --mem=120G\n") # This is specific to BlueHive cluster at RU, this is optional for your needs. 
out.write("module load sratoolkit/2.9.2\n") # loading module sratoolkit to call fasterq-dump, this is specific to the BlueHive cluster, user should skip this line if this is not similar 
out.write("\n")
