...
setwd("D:/Halushka_lab/Arun/datasets/microRNAOme2/UMAP/analysis_071721/brain_fat_RBCs/")
...
metadata <- readr::read_csv("brain_fat_RBCs_metadata.csv")

expression_df <- readr::read_csv("brain_fat_RBCs_021322.csv") %>%
...
p
htmlwidgets::saveWidget(as_widget(p), "DESeq_brainFatRBCs_021422.html")
