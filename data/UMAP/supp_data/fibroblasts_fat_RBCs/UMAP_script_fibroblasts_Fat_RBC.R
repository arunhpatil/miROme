...
setwd("D:/Halushka_lab/Arun/datasets/microRNAOme2/UMAP/analysis_071721/fibroblasts_fat_RBCs/")
...
metadata <- readr::read_csv("fibroblasts_fat_RBCs_metadata.csv")

expression_df <- readr::read_csv("fibroblasts_fat_RBCs.csv") %>%
...
p
htmlwidgets::saveWidget(as_widget(p), "DESeq_fibroblastsFatRBCs_021422.html")
