...
setwd("D:/Halushka_lab/Arun/datasets/microRNAOme2/UMAP/analysis_071721/stem_fat_RBCs/")
...
metadata <- readr::read_csv("stemFatRBCs_metadata.csv")

expression_df <- readr::read_csv("stemFatRBCs.csv") %>%
...
p
htmlwidgets::saveWidget(as_widget(p), "DESeq_StemFatRBCs_021422.html")
