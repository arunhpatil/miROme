...
setwd("D:/Halushka_lab/Arun/datasets/microRNAOme2/UMAP/analysis_071721/epithelial_fat_RBCs/")
...
metadata <- readr::read_csv("epithelialFatRBCs.csv")

expression_df <- readr::read_csv("epithelialFatRBC_DESeq_normalized_021322.csv") %>%
...
p
htmlwidgets::saveWidget(as_widget(p), "DESeq_epithelialFatRBCs_021422.html")
